...
<template>
      ...
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-[#F4F2FF]">
          <tr>
            ...
            <th scope="col" class="px-3 py-3 flex justify-end text-tertiary"><svg class="w-6 h-6" viewBox="0 0 24 24" id="three-dots"
        ...
        <tbody>
          <tr v-for="(user, index) in filteredProducts" :key="index"
            ...
            <th class="flex flex-col">
              ...
              <span class="text-xs font-normal text-tertiary">{{ user.email }}</span>
            </th>
            </td>
            ...
            <td class="px-6 py-4">
              ...
              <div class="flex flex-col gap-2">
                <div
                  class="w-[42%] inline-flex text-center items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-statusbg border-2 border-statusbg text-primary dark:text-blue-500">
                  <!-- <span >Badge</span> -->
            ...
            <td class="px-6 py-4">
              ...
              <div class="flex flex-col gap-2">
                <div
                  class="w-[43%] inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-statusbgPaid  text-primary dark:text-blue-500">
                  <!-- <span >Badge</span> -->
                  <span class="size-2 inline-block rounded-full bg-[#007F00] dark:bg-blue-500"></span>
                  <span class="text-[#007F00]">Paid</span>
                </div>
                <div>
  ...
  filteredProducts() {
    ...
    return this.paidusers.filter(paiduser => {
      const name = paiduser.name ? paiduser.name.toLowerCase() : '';
      const email = paiduser.email ? paiduser.email.toLowerCase() : '';
      const userStatus = paiduser.userStatus ? paiduser.userStatus.toLowerCase() : '';
      const paymentStatus = paiduser.paymentStatus ? product.paymentStatus.toLowerCase() : '';
