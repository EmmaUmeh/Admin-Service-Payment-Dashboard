      ...
      <div class="flex justify-between">
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-1 border-2 border-[#C6C2DE] p-1 rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#8B83BA" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-[#8B83BA]">
        ...
        <button @click="payDues" class="bg-primary text-white px-4 p-2 rounded-md font-semibold">PAY DUES</button>
      </div>
    </div>
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tr>
          <th scope="col" class="p-4">
            <div class="flex items-center">
              <input id="checkbox-all-search" type="checkbox" @change="toggleAll" v-model="selectAll"
          ...
          <th scope="col" class="px-3 py-3 flex justify-end text-tertiary">
            <svg class="w-6 h-6" viewBox="0 0 24 24" id="three-dots" xmlns="http://www.w3.org/2000/svg" fill="#000000">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <g id="_20x20_three-dots--grey" data-name="20x20/three-dots--grey" transform="translate(24) rotate(90)">
                  ...
                  <circle id="Oval" cx="1" cy="1" r="1" transform="translate(5 11)" stroke="#000000" stroke-miterlimit="10" stroke-width="0.5"></circle>
                  <circle id="Oval-2" data-name="Oval" cx="1" cy="1" r="1" transform="translate(11 11)" stroke="#000000" stroke-miterlimit="10" stroke-width="0.5"></circle>
                  <circle id="Oval-3" data-name="Oval" cx="1" cy="1" r="1" transform="translate(17 11)" stroke="#8B83BA" stroke-miterlimit="10" stroke-width="0.5"></circle>
                </g>
              </g>
            </svg>
          </th>
      ...
      <tbody>
        <tr v-for="(user, index) in filteredUsers" :key="index"
          ...
          <td class="w-4 p-4">
            <div class="flex items-center gap-3">
              <input :id="'checkbox-table-search-' + index" type="checkbox" v-model="selectedUsers" :value="user"
                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
              ...
              <span>
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    <path d="M7 10L12 15L17 10M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z"
          ...
          <td>
            <div class="flex flex-col">
              <h3 class="font-semi-bold text-tertiary whitespace-nowrap dark:text-white">{{ user.name }}</h3>
              <span
              class="text-xs font-normal text-tertiary">{{ user.email }}</span>
            </div>
          </td>
          <td class="px-6 py-4">
            <div class="flex flex-col gap-2">
              <div class="w-[42%] inline-flex text-center items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-statusbg border-2 border-statusbg text-primary dark:text-blue-500">
          ...
          <td class="px-6 py-4">
            <div class="flex flex-col">
              <span class="font-semibold">${{ user.price }}</span>
              <span>USD</span>
            </div>
          </td>
          <td>
...
export default {
  ...
  computed: {
    filteredUsers() {
      ...
      return this.unpaidusers.filter(user =>
  ...
  methods: {
    ...
    payDues() {
      this.selectedUsers.forEach(user => {
        // Update payment status for selected users
